...
function component() {
  ...
  element.innerHTML = '<article><h1>Mike Snow</h1><p class="subtitle">His website</p><section><p>Tufte CSS provides tools to style web articles using the ideas demonstrated by Edward Tufte’s books and handouts. Tufte’s style is known for its simplicity, extensive use of sidenotes, tight integration of graphics with text, and carefully chosen typography.</p><figure><img src="/static/jim_brown.jpeg"></figure></section></article>';
